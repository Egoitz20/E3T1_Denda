...
/**
 * Storage produktuen taula leihoaren kontrolagailua.
 * <p>
 * Klase honek Storage kategorian dauden produktu guztiak erakusten ditu taula batean,
...
public class StorageTaulaKontrolagailua extends HandlerGlobala {
    ...
    public void gehituOtzara() {
        ...
        eguneratuBezeroKategoriaOrriaDatuak(pagination.getCurrentPageIndex(), storageList, tableView);
